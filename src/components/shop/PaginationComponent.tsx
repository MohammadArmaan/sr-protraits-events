...
import { updateQuery } from "@/lib/vendor/shop-url";
...
export function PaginationComponent({ page, totalPages, hasNext, hasPrev }: Props) {
        ...
        <div className="mt-10 flex justify-center">
            <div className="flex items-center gap-2 flex-wrap">
                ...
                <Button
                    ...
                    disabled={!hasPrev}
                    onClick={() =>
                        updateQuery(router, searchParams, "page", page - 1)
                    }
                >
                    <ChevronLeft />
                </Button>
                    ...
                    {pagesToShow.map((p, idx) =>
                        p === "dots" ? (
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    updateQuery(router, searchParams, "page", p)
                                }
                            >
                                {p}
                            </Button>
