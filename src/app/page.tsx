...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      description: "Showcase your photography and event services to potential clients"
    },
    {
      icon: Users,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-300/70 via-muted/20 to-background">
      {/* Hero Section */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="border shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
        ...
        <Card className="border shadow-2xl overflow-hidden">
          <CardContent className="p-0">
            <div className="grid md:grid-cols-2 gap-0">
              {/* Left Side */}
              <div className="bg-gradient-primary p-12 flex flex-col justify-center items-start text-primary-foreground min-h-[400px]">
                <Badge className="bg-gradient-primary-foreground/20 text-primary-foreground border-0 mb-6">
                  Vendor Benefits
                </Badge>
                ...
                <div className="mt-8 flex items-center gap-3 bg-gradient-primary-foreground/10 rounded-full px-6 py-3 backdrop-blur-sm">
              ...
              <div className="p-12 bg-card flex flex-col justify-center">
      ...
      <div className="container mx-auto px-4 py-16 pb-24">
        <Card className="border-0 shadow-2xl bg-gradient-primary text-primary-foreground overflow-hidden relative">
          ...
          <CardContent className="p-12 md:p-16 text-center relative z-10">
            ...
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              Be among the first vendors on our platform. 
              Start receiving bookings today.
            </p>
            <Button
              size="lg"
              className="px-10 py-6 text-lg font-semibold bg-white text-black hover:bg-white/80"
              onClick={() => router.push("/vendor")}
            >
              Start Your Journey
              <ArrowRight className="ml-2 h-5 w-5" />
